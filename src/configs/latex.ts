...
export const FORMULA_LIST = [
  {
    label: i18n.global.t('latex.gaussianFormula'),
...
export const SYMBOL_LIST = [
  {
    type: 'operators',
    label: i18n.global.t('latex.operators'),
    children: [
      { latex: '\\cdot' },
      { latex: '\\pm' },
      { latex: '\\mp' },
  ...
  {
    type: 'group',
    label: i18n.global.t('latex.group'),
    children: [
      { latex: '\\frac{a}{b}' },
      { latex: '\\frac{dx}{dx}' },
  ...
  {
    type: 'verbatim',
    label: i18n.global.t('latex.verbatim'),
    children: [
      { latex: '\\log' },
      { latex: '\\ln' },
      { latex: '\\exp' },
  ...
  {
    type: 'greek',
    label: i18n.global.t('latex.greek'),
    children: [
      { latex: '\\alpha' },
      { latex: '\\beta' },
      { latex: '\\gamma' },
