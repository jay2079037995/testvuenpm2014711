...
export const CLIPPATHS: ClipPath = {
  ...
  round2DiagRect: {
    ...
    type: ClipPathTypes.RECT,
    radius: '20px',
    style: 'inset(0 0 0 0 round 50px 0 50px 10px)',
    // createPath: (width: number, height: number) => {
    //   // M 0 0 L 150 0 Q 200 0 200 50 L 200 200 L 50 200 Q 0 200 0 150 L 0 50 Z
    //   // M 50 0 L 200 0 L 200 150 Q 200 200 150 200 L 0 200 L 0 50 Q 0 0 50 0 Z
    //   // M 50 0 L 150 0 Q 200 0 200 50 L 200 150 Q 200 200 150 200 L 50 200 Q 0 200 0 150 L 0 50 Q 0 0 50 0 Z
    //   return `M ${width * 0.1} 0 L ${width} 0 Q ${width} 0 ${width} ${height * 0} L ${width} ${height - width * 0.1} Q ${width} ${height} ${width * 0.9} ${height} L ${width * 0} ${height} Q 0 ${height} 0 ${height - width * 0.1} L 0 ${width * 0.1} Q 0 0 ${width * 0.1} 0 Z`
    // }
  },
  ellipse: {
    name: '圆形',
