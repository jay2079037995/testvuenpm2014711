...
export const SHAPE_LIST: ShapeListItem[] = [
  {
    type: i18n.global.t('canvasTool.rectangle'),
    children: [
      {
        viewBox: [200, 200],
      ...
      },
      {
        ...
        title: i18n.global.t('canvasTool.arbitraryPolygon'),
      },
    ]
  },

  {
    type: i18n.global.t('canvasTool.commonShapes'),
    children: [
      {
        viewBox: [200, 200],
  ...
  {
    type: i18n.global.t('canvasTool.arrow'),
    children: [
      {
        viewBox: [200, 200],
  ...
  {
    type: i18n.global.t('canvasTool.otherShapes'),
    children: [
      {
        viewBox: [1024, 1024],
  ...
  {
    type: i18n.global.t('canvasTool.linear'),
    children: [
      {
        viewBox: [1024, 1024],
