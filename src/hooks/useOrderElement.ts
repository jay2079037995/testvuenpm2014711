...
export default () => {
  ...
  const orderElement = (element: PPTElement, command: ElementOrderCommands) => {
    ...
    if (command === ElementOrderCommands.UP) newElementList = moveUpElement(elements, element)
    else if (command === ElementOrderCommands.DOWN) newElementList = moveDownElement(elements, element)
    else if (command === ElementOrderCommands.TOP) newElementList = moveTopElement(elements, element)
    else if (command === ElementOrderCommands.BOTTOM) newElementList = moveBottomElement(elements, element)
