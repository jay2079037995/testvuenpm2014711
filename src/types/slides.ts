...
import type { PPTistLineConnector } from './slidesPPTist'
import type { ClipPathTypes } from '@/configs/imageClip'
...
export interface PPTLineElement extends Omit<PPTBaseElement, 'height' | 'rotate'> {
  ...
  brokens?: Array<[number, number]>
  curve?: [number, number]
  cubic?: [[number, number], [number, number]]
  lineConnector?: PPTistLineConnector
}
...
export interface ChartDataSingleSeries {
  labels: string[]
  legends: string[]
  series: number[]
}
