...
import MenuContentText from './MenuContent.vue'
import MenuContent from '../Contextmenu/MenuContent.vue'
...
const isText = computed(() => {
  return handleElement.value?.type === 'text'
})
...
const style = computed(() => {
  ...
  const MENU_WIDTH = handleElement.value?.type === 'text' ? 400 : 170
