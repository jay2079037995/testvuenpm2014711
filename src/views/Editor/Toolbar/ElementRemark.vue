<template>
    <div class="element-positopn-panel">
      ...
      <ButtonGroup class="row">
        <Button style="flex: 1;" v-tooltip="$t('edit.leftAligned')" @click="alignElementToCanvas(ElementAlignCommands.LEFT)"><IconAlignLeft /></Button>
        <Button style="flex: 1;" v-tooltip="$t('edit.horizontally')" @click="alignElementToCanvas(ElementAlignCommands.HORIZONTAL)"><IconAlignVertically /></Button>
        <Button style="flex: 1;" v-tooltip="$t('edit.rightAligned')" @click="alignElementToCanvas(ElementAlignCommands.RIGHT)"><IconAlignRight /></Button>
      </ButtonGroup>
      <ButtonGroup class="row">
        <Button style="flex: 1;" v-tooltip="$t('edit.alignUp')" @click="alignElementToCanvas(ElementAlignCommands.TOP)"><IconAlignTop /></Button>
        <Button style="flex: 1;" v-tooltip="$t('edit.verticalCenter')" @click="alignElementToCanvas(ElementAlignCommands.VERTICAL)"><IconAlignHorizontally /></Button>
        <Button style="flex: 1;" v-tooltip="$t('edit.bottomJustify')" @click="alignElementToCanvas(ElementAlignCommands.BOTTOM)"><IconAlignBottom /></Button>
      </ButtonGroup>
