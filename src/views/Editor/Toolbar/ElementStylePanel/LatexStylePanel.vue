<template>
  <div class="latex-style-panel">
    <div class="row">
      <Button style="flex: 1;" @click="latexEditorVisible = true">{{ $t('latex.editLatex') }}</Button>
    </div>

    <Divider />

    <div class="row">
      <div style="width: 40%;">{{ $t('latex.color') }}</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('latex.thickness') }}</div>
      <NumberInput 
        :min="1"
        :max="3"
