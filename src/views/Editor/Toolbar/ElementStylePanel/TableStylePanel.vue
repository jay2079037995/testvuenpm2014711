  ...
  <div class="table-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton first v-tooltip="$t('panel.textColor')" :color="textAttrs.color">
          <IconText />
        </TextColorButton>
      </Popover>
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton last v-tooltip="$t('panel.cellFill')" :color="textAttrs.backcolor">
          <IconFill />
        </TextColorButton>
      </Popover>
    </ButtonGroup>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('canvasTool.tableRow') }}</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('canvasTool.tableCol') }}</div>
      <div class="set-count" style="width: 60%;">
    ...
    <div class="row theme-switch">
      <div style="width: 40%;">{{ $t('panel.enableThemTable') }}</div>
    ...
    <template v-if="theme">
      ...
      <div class="row">
        <Checkbox 
          ...
          style="flex: 1;"
        >{{ $t('panel.firstColumn') }}</Checkbox>
        <Checkbox 
          @update:value="value => updateTheme({ colFooter: value })" 
          :value="theme.colFooter" 
          style="flex: 1;"
        >{{ $t('panel.lastColumn') }}</Checkbox>
      </div>
      <div class="row">
        <div style="width: 40%;">{{ $t('panel.themeColor') }}</div>
...
const textAttrs = ref({
  ...
  backcolor: '',
  fontsize: '12px',
  fontname: i18n.global.t('font.microsoftYahei'),
  align: 'left',
})
...
const updateTextAttrState = () => {
  ...
  if (!style) {
    ...
    textAttrs.value = {
      ...
      fontname: style.fontname || i18n.global.t('font.microsoftYahei'),
...
const toggleTheme = (checked: boolean) => {
  if (checked) {
    ...
    addHistorySnapshot()
    yjsDeleteElementAttributes(handleElementId.value, ['theme'])
  }
}
