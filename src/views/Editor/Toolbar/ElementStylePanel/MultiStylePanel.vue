<template>
  <div class="multi-style-panel">
    <div class="row">
      <div style="width: 40%;">{{ $t('panel.fillColor') }}</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('panel.borderStyle') }}</div>
      <Select 
        style="width: 60%;" 
        :value="outline.style || ''"
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('panel.borderColor') }}</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('panel.borderThickness') }}</div>
      <NumberInput 
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton first :color="richTextAttrs.color" v-tooltip="$t('panel.textColor')">
          <IconText />
        </TextColorButton>
      </Popover>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton :color="richTextAttrs.backcolor" v-tooltip="$t('panel.textHigh')">
          <IconHighLight />
        </TextColorButton>
      </Popover>
      <Button 
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="$t('panel.leftAligned')"><IconAlignTextLeft /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="$t('panel.center')"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="$t('panel.rightAligned')"><IconAlignTextRight /></RadioButton>
    </RadioGroup>
  </div>
</template>
