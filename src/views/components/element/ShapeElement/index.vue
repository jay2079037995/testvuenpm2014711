...
const isPathCorrect = (path:string):boolean => {
  return path.indexOf('MNaN') !== -1 ? true : false
}

const props = defineProps<{
  pageId: string
  elementInfo: PPTShapeElement
  selectElement: (e: MouseEvent | TouchEvent, element: PPTShapeElement, canMove?: boolean, pageId?: string) => void
