<template>
  ...
  >
    ...
    >
      ...
      <tbody>
        <tr v-for="(rowCells, rowIndex) in tableCells" :key="rowIndex" :style="{ }">
          <td 
            class="cell"
            :class="{
            ...
            :style="{
              ...
              height: cell.cellHeight + 'px',
              width: cell.cellWidth + 'px',
              writingMode: cell.vert && cell.vert === true ? 'vertical-rl' : 'horizontal-tb' 
            }"
...
import type { PPTElementOutline, PPTTableElement, TableCell, TableTheme } from '@/types/slides'
...
const handleInput = debounce(function(value, rowIndex, colIndex) {
  ...
  yjsSetElementAttributes(props.elementInfo.id, { 'data': props.data })
