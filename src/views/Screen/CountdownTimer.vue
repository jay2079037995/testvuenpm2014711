<template>
  ...
  >
    <div class="header">
      <span class="text-btn" @click="toggle()">{{ inTiming ? $t('video.pause') : $t('video.start')}}</span>
      <span class="text-btn" @click="reset()">{{ $t('edit.reset') }}</span>
      <span class="text-btn" @click="toggleCountdown()" :class="{ 'active': isCountdown }">{{ $t('video.countdown') }}</span>
    </div>
    <div class="content">
      <div class="timer">
        <input 
